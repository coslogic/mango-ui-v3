...
export const ENDPOINTS: EndpointInfo[] = [
  {
    name: 'mainnet',
    url: process.env.NEXT_PUBLIC_ENDPOINT || 'https://solana-api.projectserum.com', //https://mango.rpcpool.com //https://solana-api.tt-prod.net
    websocket: process.env.NEXT_PUBLIC_ENDPOINT || 'https://solana-api.projectserum.com', //https://mango.rpcpool.com //https://solana-api.tt-prod.net
    custom: false,
  },
  {
    name: 'devnet',
